...
<body>
	...
	<c:if test="${empty adminObj }">
		<!-- this is for when you open your logged in page un new tab and logged out from previous tab then it will redirect you to "/admin_login.jsp" page -->
			...
			<div class="col-md-4">
				<div class="card paint-card">
					<div class="card-body text-center text-success">
						...
						<p class="fs-4 text-center">
							Total Appoiment <br><%=dao.countAppointment()%>
						</p>
					</div>
				</div>
			</div>
