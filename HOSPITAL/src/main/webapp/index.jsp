...
<body>
	...
	<%-- <%Connection conn=DBConnect.getConn();  //DBMS connection Checking purpose 
	out.print(conn);
	%> --%>
	...
	<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-4 ">
				<img alt="" src="img/doctor.jpg" height="290px" >
			</div>
		...
		<p class="text-center fs-2">Our Team</p>
			<div class="row">
				...
				<div class="col-md-3">
					<div class="card paint-card">
						<div class="card-body text-center">
						<img alt="" src="img/doc2.jpg" width="250px" height="300px"><img alt="" src="">
				...
				<div class="col-md-3">
					<div class="card paint-card">
						...
						<p class="fw-bold fs-5">Dr .nuisse paule</p>
						<p class="fs-7">(chief Doctor)</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="card paint-card">
						...
						<p class="fw-bold fs-5">Dr .Mathue Samule</p>
						<p class="fs-7">(chief Doctor)</p>
						</div>
					</div>
				</div>
